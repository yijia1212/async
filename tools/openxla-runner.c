...
iree_status_t async_callback(void* user_data, iree_loop_t loop, iree_status_t status, iree_vm_list_t* outputs){
...
int main(int argc, char** argv) {
  ...
  IREE_CHECK_OK(
      iree_async_runtime_module_create(instance, allocator, &async_runtime_module));
  ...
  iree_vm_ref_t input_ref = iree_async_token_move_ref(token);
