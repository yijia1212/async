...
static void iree_loop_async_run_wait_any(iree_loop_t loop,
...
static void iree_loop_async_run_wait_all(iree_loop_t loop,
                                         iree_loop_wait_multi_params_t params) {
  IREE_TRACE_ZONE_BEGIN(z0);
...
static void iree_loop_async_dequeue_and_run_next(iree_loop_async_ring_t *ring) {
